...
export const PosBillingView: React.FC = () => {
  const [cart, setCart] = useState<CartItem[]>([
    { id: 1, name: 'Amul Taaza Milk 500ml', hindi: 'अमूल ताजा दूध', price: 27, qty: 3, unit: 'pkts' },
    { id: 2, name: 'Madhur Pure Sugar 1kg', hindi: 'मधुर चीनी', price: 48, qty: 2, unit: 'kg' },
    { id: 3, name: 'Britannia Daily Bread 400g', hindi: 'ब्रिटानिया ब्रेड', price: 45, qty: 1, unit: 'pkt' },
    { id: 4, name: 'Aashirvaad Atta 10kg', hindi: 'आशीर्वाद आटा', price: 420, qty: 1, unit: 'bag' },
    { id: 5, name: 'Fortune Mustard Oil 1L', hindi: 'फॉर्च्यून सरसों तेल', price: 138, qty: 1, unit: 'btl' },
  ]);
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 py-2">
      ...
      <div className="lg:col-span-8 space-y-4">
        ...
        <div className="bg-emerald-900 text-white rounded-2xl p-4 shadow-md flex items-center justify-between">
          ...
          <button
            onClick={() => setVoiceInput('5 kg Atta, 1L Mustard Oil added')}
            className="bg-amber-400 hover:bg-amber-500 text-slate-950 px-3 py-1.5 rounded-lg text-xs font-bold shadow-sm"
          >
            Process Voice
          </button>
        </div>
      ...
      <div className="lg:col-span-4 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between space-y-4">
        ...
        <div className="space-y-3 pt-3 border-t border-slate-100">
          <div className="flex justify-between items-baseline">
            <span className="text-xs text-slate-500 font-medium">Total Payable (कुल देय राशि)</span>
